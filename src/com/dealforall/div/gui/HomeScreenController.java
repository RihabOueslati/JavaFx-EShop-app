...
import com.dealforall.div.dao.classes.MessagerieDAO;
import com.dealforall.div.dao.classes.NewsletterDAO;
import com.dealforall.div.dao.classes.UserDAO;
import com.dealforall.div.LIBS.FileHandler;
import com.dealforall.div.LIBS.Ftp;
import com.dealforall.div.LIBS.StackEcrans;
import com.dealforall.div.PIDEV.Launcher;
...
private Media me1;
    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      new Thread(taskDownloadMedia).start();
        ...
        String path = new File("src/com/dealforall/div/media/2016-range-rover-evoque.mp4").getAbsolutePath();
        ...
        me1=new Media(new File(path).toURI().toString());
   ...
   FileHandler.deleteFile(FILE_PATH);
    ...
    public void setProfile(User user, NewsletterDAO news) {
        ...
        if (user.getClass().getSimpleName().equals("Administrateur")) {
            ...
            Image img = new Image(getClass().getResource("/com/dealforall/div/ressources/images/user_gold.jpg").toExternalForm());
            profile_pic.setImage(img);
        }
        if (user.getClass().getSimpleName().equals("Abonne")) {
            typeC.setText("Abonné");
            Image img = new Image(getClass().getResource("/com/dealforall/div/ressources/images/user_silver.jpg").toExternalForm());
            profile_pic.setImage(img);
        }
    ...
    public void setVisitor(NewsletterDAO news) {
      ...
      /*  /* ABOUT & COTACT */
        Hyperlink btnAbout = new Hyperlink("DEAL FOR ALL");
        btnAbout.setLayoutX(48);
        btnAbout.setLayoutY(25);

        Hyperlink btnContact = new Hyperlink("CONSULTER NOTRE SITE");
        btnContact.setLayoutX(48);
        btnContact.setLayoutY(55);

        /* INFO & CONTACT IMAGES */
        ImageView infoImg = new ImageView(new Image("/com/dealforall/div/ressources/images/info.png"));
        infoImg.setLayoutX(12);
        infoImg.setLayoutY(18);
        infoImg.setFitWidth(40);
        infoImg.setPreserveRatio(true);

        ImageView emailImg = new ImageView(new Image("/com/dealforall/div/ressources/images/email.png"));
    ...
    public void setNavigation(ActionEvent e) throws Exception{
        ...
        if((Button)e.getSource() == contact){
            showAboutScreen("aPropos");
        }
        if((Button)e.getSource() == about){
            showAboutScreen("contactForm");
        }
