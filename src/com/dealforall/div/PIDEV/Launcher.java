 ...
 */
package com.dealforall.div.PIDEV;
...
public class Launcher extends Application {
    ...
    public static final String APPLICATION_ICON
            = "/com/dealforall/div/ressources/images/logo.png";
    ...
    public void init() throws IOException, URISyntaxException, Exception {
        ...
        loadProgress.setStyle("-fx-accent: #32bea6; -fx-border-color: black; -fx-border-radius: 20px;");
    ...
    public void showMainStage() {
        ...
        try {          
            ...
            stage.setTitle("Home | deal for all");
